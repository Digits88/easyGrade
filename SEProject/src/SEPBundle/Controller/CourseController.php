...
use SEPBundle\Entity\Course;
use SEPBundle\Form\CourseType;
...
class CourseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $courses = $em->getRepository('SEPBundle:Course')->findAll();
    ...
    {
        $course = new Course();
        $form = $this->createForm('SEPBundle\Form\CourseType', $course);
    ...
    {
        $deleteForm = $this->createDeleteForm($course);
        $editForm = $this->createForm('SEPBundle\Form\CourseType', $course);
